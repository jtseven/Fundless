...
class Dashboard:
    ...
    def __init__(self, config: Config, analytics: PortfolioAnalytics):
        ...
        @self.app.callback(
            Output("holdings_table", "children"),
        ...
        @self.app.callback(
            Input("custom-weighting-collapse", "is_open"),
        ...
        def update_index_coins(_, __, ___):
            ...
            return (
                buttons,
                layouts.savings_plan_info(analytics),
